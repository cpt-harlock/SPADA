...
set output 'recirculation_overall.png'
...
set yrange [ * : 3.1 ] noreverse writeback
set y2range [ * : * ] noreverse writeback
set zrange [ * : * ] noreverse writeback
set cbrange [ * : * ] noreverse writeback
set rrange [ * : * ] noreverse writeback
set style histogram clustered gap 1 title offset 0,-0.7
...
#set key box opaque 
set margins 6.1, 0.2, 2.7, 0.1


plot \
newhistogram "m=64", 'recirculation_overall.dat'\
...
newhistogram "m=128" at 4.2, 'recirculation_overall.dat'\
