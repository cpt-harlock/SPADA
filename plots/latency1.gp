...
plot 'fpga_latency_1/latency_results_key_every_1_pkts.dat' index 0 using ($1*100):2 t '1 every 1 pkts' w l lt 1 lc 6 lw 2, \
	 'fpga_latency_1/latency_results_key_every_3_pkts.dat' index 0 using ($1*100):2 t '1 every 3 pkts' w l ls 2 lw 2, \
	 'fpga_latency_1/latency_results_key_every_5_pkts.dat' index 0 using ($1*100):2 t '1 every 5 pkts' w l ls 3 lw 2, \
	 'fpga_latency_1/latency_results_key_every_10_pkts.dat' index 0 using ($1*100):2 t '1 every 10 pkts' w l ls 4 lw 2, \
	 'fpga_latency_1/latency_results_key_every_20_pkts.dat' index 0 using ($1*100):2 t '1 every 20 pkts' w l ls 5 lw 2
